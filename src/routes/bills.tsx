...
import { ListBulletIcon, Pencil2Icon, TrashIcon, Pencil1Icon, Cross2Icon, PlusIcon, ArrowLeftIcon } from '@radix-ui/react-icons';
        ...
        <AppLayout>
            <main className="flex-1 w-full min-h-0 overflow-y-auto p-4 sm:p-10">
                <div className="w-full px-2 sm:px-4 text-left">
                    ...
                    <SectionHeader
                        icon={<ListBulletIcon className="relative w-7 h-7 text-white drop-shadow-[0_0_6px_rgba(34,211,238,0.7)]" />}
                            ...
                            {bills.data?.map((bill: any) => (
                                ...
                                >
                                    <div className="flex flex-col flex-1 relative z-10 gap-3">
                                        ...
                                        <span className="text-neutral-200 text-xl font-extrabold mb-2 tracking-wide">${bill.amount.toFixed(2)}</span>
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {bill.isAutoPay && (
                                                <Badge variant="success">Auto-Pay</Badge>
                                            )}
                                        </div>
                                    </div>
                                </div>
