...
export const SciFiDialog: React.FC<SciFiDialogProps> = ({
  open,
  onOpenChange,
  title,
  children,
  ...
  <Dialog.Root open={open} onOpenChange={onOpenChange}>
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed z-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-zinc-950 rounded-2xl shadow-2xl p-8 w-full max-w-lg border border-cyan-700/40">
        ...
        {title && (
          <h2 className="text-2xl font-extrabold text-cyan-300 mb-6 drop-shadow-[0_0_4px_rgba(34,211,238,0.3)]">{title}</h2>
        )}
