...
export function AppLayout({ level = 3, xp = 1250, xpMax = 2000, children }: AppLayoutProps) {
	return (
...
function Avatar({ avatarUrl, onClick }: AvatarProps) {
	return (
		<button
			className="bg-cyan-500 rounded-full w-10 h-10 flex items-center justify-center font-bold focus:outline-none focus:ring-2 focus:ring-cyan-400 hover:brightness-110 transition"
			onClick={onClick}
			title="Change avatar"
			type="button"
