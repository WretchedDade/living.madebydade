...
export function RecentActivitySection({ activities = [], isLoading = false }: RecentActivitySectionProps) {
	return (
		<div className="bg-background rounded-2xl p-4 md:p-6 shadow-lg">
			...
			/>
			{isLoading ? (
				<div className="text-primary text-center py-6 animate-pulse text-lg">Loading activity...</div>
			) : activities.length === 0 ? (
				<div className="text-muted-foreground text-center py-6 text-lg italic">
